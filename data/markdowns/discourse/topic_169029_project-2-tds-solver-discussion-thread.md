...
### Post #25 by Praul Ayar on 2025-03-04T17:08:02.875Z
...
### Post #34 by Shalini Saravanan on 2025-03-06T11:22:47.655Z
...
[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/1/5/151998ae4289188b8c48eb508b07d5b5be92100a.png)image1260×149 8.95 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/1/5/151998ae4289188b8c48eb508b07d5b5be92100a.png)
...
The value associated with `"answer"` is an escaped JSON string (indicated by `\"` for inner double quotes). This inner, escaped JSON object contains two primary keys:
...
This table represents a collection of sales transactions, providing details about each transaction, the customer, their country, the date, the product sold, and the associated sales and cost figures.
...
> **Image Description**: The image displays a partial vertical list of media entries, likely movies or TV shows, within a digital interface.
...
[](#p-611318-note-it-would-be-better-to-check-your-responses-on-the-tds-portal-before-finalising-the-script-you-can-access-the-answer-box-and-check-button-by-removing-the-disable-attribute-4)
...
> **Image Description**: The image displays a Google Colab task consisting of instructions, Python code, and a question.
...
### Post #107 by Aarush saxena  on 2025-03-26T04:35:37.877Z
...
[](#p-611536-questions-requiring-clarificationmanual-intervention-for-evaluation-as-discussed-in-tuesdays-session-1)
...
[](#p-611536-questions-requiring-manual-intervention-portal-side-issue-2)
![:red_exclamation_mark:](https://emoji.discourse-cdn.com/google/red_exclamation_mark.png?v=14)
...
Reference:
[GA4 Q2 and Q10 resolution](https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/98)
...
[](#p-611536-deployment-related-issues-to-be-included-in-thursdays-session-3)
...
### Post #108 by Saransh Saini on 2025-03-26T07:18:55.105Z
...
### Post #109 by Tushar Jalan  on 2025-03-26T07:37:59.662Z
...
### Post #110 by Andrew David on 2025-03-26T10:42:30.198Z
...
### Post #111 by Saransh Saini on 2025-03-26T11:41:58.981Z
...
![:victory_hand:](https://emoji.discourse-cdn.com/google/victory_hand.png?v=14)

---

### Post #112 by Saransh Saini on 2025-03-26T11:46:58.695Z
...
### Post #113 by Saransh Saini on 2025-03-26T11:49:47.787Z
...
### Post #114 by Pradeep Mondal on 2025-03-26T11:59:37.194Z
...
### Post #116 by Jivraj Singh Shekhawat on 2025-03-26T12:03:38.632Z
...
### Post #117 by Saransh Saini on 2025-03-26T12:07:18.924Z
...
### Post #118 by Trebhuvan SB on 2025-03-26T14:02:52.013Z
...
### Post #119 by Manmeet Kaur on 2025-03-27T00:16:27.539Z
...
### Post #120 by Tushar Jalan  on 2025-03-27T04:20:31.097Z
...
### Post #121 by Saransh Saini on 2025-03-27T04:45:52.559Z
...
### Post #122 by Shivaditya Bhattacharya on 2025-03-27T06:45:58.204Z
...
### Post #123 by Carlton D'Silva on 2025-03-27T07:05:51.741Z
...
> **Image Description**: The image displays a terminal window showing the execution of a Python script.

The command prompt, `.venvcarland@Carlton-MacBook-Pro tds %`, is followed by the execution of the script `/User/tds/test.py`.

The output of the script is a multiline string:
"This is a multiline
string that spans
multiple lines       with        spaces
and some newlines
...
This output demonstrates a string containing newlines, multiple spaces, and a tab character. Following the script's execution, the command prompt reappears.
Screenshot 2025-03-27 at 1.09.56 pm323×120 3.61 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/a/d/ad116ba310657f4688bc4744ea6f291fddcb63b8.png)
...
> **Image Description**: The image displays a terminal session showing the execution of a command or script and its output.

1.  **Prompt:** The first line, `• .venvcarland@Carlton-MacBook-Pro tds %`, shows a shell prompt, indicating a user in a virtual environment (`.venvcarland`) on a `Carlton-MacBook-Pro` machine, within the `tds` directory.
2.  **Command/Path:** The second line, `tds/test.py`, indicates a file path, likely a Python script, that was executed.
3.  **Output:** The third line, `{"mary": "poppins", "age": 42}`, is the output of the executed command, presented as a JSON object or Python dictionary.
4.  **New Prompt:** The fourth line, `✧ .venvcarland@Carlton-MacBook-Pro tds %`, shows a new shell prompt, indicating the system is ready for the next command.
...
### Post #124 by Pradeep Mondal on 2025-03-27T08:27:33.282Z
...
### Post #125 by Vicky Kumar on 2025-03-27T09:19:43.245Z
...
### Post #126 by LAKSHAY on 2025-03-27T10:01:02.958Z
...
> **Image Description**: The image displays two panels related to web interactions and GitHub Pages.

The left panel shows a successful (HTTP 200 OK) server response to a request made to `http://127.0.0.1:1000/api`. The response body is a JSON object `{"answer": "https://23F3001076.github.io/github-pages-20250327144836/"}`. Response headers indicate `content-type: application/json`, `server: uvicorn`, and a date of `Thu, 27 Mar 2025`.

The right panel provides information and a question about GitHub Pages. It explains that GitHub Pages obfuscates emails via Cloudflare, demonstrating an obfuscated email within an HTML `<a>` tag: `23F3001076@s.study.lite.ac.ir`. A question asks "What is the GitHub Pages URL?", providing a format example `https://[USER].github.io/[REPO]/`. The solution field shows `https://23F3001076.github.io/github-pages-20250327144836` marked as "Correct", which matches the URL from the API response in the left panel. A note at the bottom suggests adding `?v=s, ?v=t` to a URL to bust the cache.
image1854×493 55.9 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/3/5/358458a56d720a8ecdd43ce5d1de17cde7c76caa.png)

---

### Post #127 by LAKSHAY on 2025-03-27T10:21:52.862Z
...
[](#p-611884-final-thoughts-on-project-2-1)
...
### Post #128 by Pradeep Mondal on 2025-03-27T10:30:29.421Z
...
### Post #129 by Pradeep Mondal on 2025-03-27T10:37:09.639Z
...
### Post #130 by Pradeep Mondal on 2025-03-27T10:51:35.130Z
...
### Post #131 by Trebhuvan SB on 2025-03-27T13:16:23.681Z
...
### Post #132 by Aditi Shastri on 2025-03-27T15:02:27.784Z
...
> **Image Description**: The image displays a data processing task titled "Your Task." It describes a GZipped Apache log file (61MB, 258,074 rows) from May 2024 for the site `s-anand.net`.

Each row of the log file contains 9 defined fields:
*   IP: IP address of the visitor.
*   Remote logname: Remote logname.
*   Remote user: Remote user.
*   Time: Time of visit (e.g., `[01/May/2024:00:00:00 +0000]`), noted as unquoted.
*   Request: Three space-separated parts (Method, URL, Protocol).
*   Status: HTTP status code (200-299 indicates success).
*   Size: Size of response in bytes.
*   Referer: Referer URL.
*   User agent: Browser used, which may contain spaces and escaped quotes.
*   Vhost: Virtual host.
*   Server: Server IP address.

The data format specifies that fields are space-separated and double-quoted (`"`), with quoted fields escaping internal quotes via `\"` (affecting 41 rows). All data and questions are in the GMT-0500 timezone.

Two tasks are visible:
1.  **Filter the Log Entries**: Extract requests where the URL starts with `/malayalammp3/` and the request date is 2024-05-15.
2.  **Aggregate Data by IP**: Sum the "Size" field for each unique IP address from the filtered entries. (The remainder of this instruction is cut off).
WhatsApp Image 2025-03-27 at 13.41.43_5bd0a1821600×1069 246 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/4/d/4d95a26e7ed85f52ff71db596714dbbe5700b798.jpeg)
...
[anand.net](http://anand.net)
 is a personal website that had region-specific music content. One of the site’s key sections is tamilmp3, which hosts music files and is especially popular among the local audience. The website is powered by robust Apache web servers that record detailed access logs. These logs are essential for understanding user behavior, server load, and content engagement. By analyzing the server’s Apache log file, the author can identify heavy users and take measures to manage bandwidth, improve site performance, or even investigate potential abuse. Your Task: This GZipped Apache log file has 258,074 rows. Each row is an Apache web log entry for the site
[s-anand.net](http://s-anand.net)
 in May 2024. Each row has these fields:
...
Referer: The referer URL. E.g.
[https://s-anand.net/](https://s-anand.net/)
.
...
I would appreciate your clarification on whether the
.gz
 file should be directly included in the API request or if a Google Drive link should be provided instead.

Thank you for your time and assistance.

---

### Post #133 by Vicky Kumar on 2025-03-27T22:40:49.200Z
...
### Post #134 by Dhruv Agrawal on 2025-03-28T04:05:30.133Z
...
### Post #135 by Vicky Kumar on 2025-03-28T05:35:05.390Z
...
### Post #136 by Parthiv on 2025-03-28T05:44:20.301Z
...
### Post #137 by LAKSHAY on 2025-03-28T06:36:01.976Z
...
### Post #138 by Dhruv on 2025-03-28T10:04:04.208Z
...
### Post #139 by Parthiv on 2025-03-28T11:02:01.184Z
...
Let’s make sure you know how to use JSON. Sort this JSON array of objects by the value of the
age
 field. In case of a tie, sort by the
name
 field. Paste the resulting JSON below without any spaces or newlines.
...
### Post #140 by Lovepreet Singh on 2025-03-28T14:46:03.074Z
...
### Post #141 by Aditi Shastri on 2025-03-28T14:46:13.177Z
...
### Post #142 by Saransh Saini on 2025-03-28T17:06:27.212Z
...
The
.gz
 file would be sent along with the API request. You can even read the file directly without even downloading it.

---

### Post #143 by Saransh Saini on 2025-03-28T17:08:40.422Z
...
### Post #146 by Saransh Saini on 2025-03-28T17:34:15.676Z
...
### Post #147 by Dhruv on 2025-03-28T17:37:01.640Z
...
### Post #148 by Saransh Saini on 2025-03-28T17:51:51.783Z
...
### Post #149 by LAKSHAY on 2025-03-28T17:54:02.456Z
...
### Post #150 by Kushagra Barodekar on 2025-03-28T18:02:30.719Z
...
### Post #151 by Saransh Saini on 2025-03-28T18:06:17.148Z
...
### Post #152 by Pradeep Mondal on 2025-03-28T18:26:21.832Z
...
### Post #153 by Pradeep Mondal on 2025-03-29T05:15:05.415Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/153

[@carlton](/u/carlton)
 in GA 5 q10 the mappings table is sent as part of the question text or any other separate file?
...
### Post #154 by Maheshwar Ture on 2025-03-29T05:34:08.665Z
...
### Post #155 by Vicky Kumar on 2025-03-29T05:52:24.761Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/155

Hello Sir,

I want to express my gratitude for the opportunity to work on this project. I have developed a mini chatbot backend using
vicky_server.py
, which handles question matching and execution internally, producing appropriate responses.
My mini chatbot is capable of creating its own API using REST and can manage tasks such as image compression, repository management, workflows, and web scraping related to graded assignments. It can even calculate total marks for subjects like physics and convert PDFs into markdown content. Additionally, it is capable of downloading the Llama model and creating a tunnel using ngrok. Essentially, it can address the first four assignment questions.
...
Furthermore, there is an issue with question matching. At times, the system incorrectly identifies questions containing the word “code” and executes
first.py
 for GA1.
...
my model at
[Vicky kumar tds](https://310c-43-230-107-168.ngrok-free.app/)

---

### Post #156 by Saransh Saini on 2025-03-29T06:21:27.025Z
...
### Post #157 by LAKSHAY on 2025-03-29T06:29:59.790Z
...
> **Image Description**: The image displays a Python code snippet within an interactive environment, likely a Jupyter notebook cell, along with its execution output.

The code block contains three lines:
1.  `import json`: Imports the standard `json` module.
2.  `my_response = "{\"answer\": \"26272\"}"`: Defines a string variable `my_response` containing a JSON-formatted string. The string represents a dictionary with a single key "answer" and a string value "26272". The double quotes within the JSON string are escaped with backslashes.
3.  `print(json.loads(my_response)["answer"])`: This line first uses `json.loads()` to parse the `my_response` string into a Python dictionary. Then, it accesses the value associated with the key "answer" from this dictionary and prints it to the console.

Below the code block, the output of the execution is shown as "26272", consistent with the value extracted from the JSON string.
image726×224 4.68 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/b/2/b2c5345c348f63fcf52240ba6c07cb8655d7d17c.png)
...
> **Image Description**: The image displays a Python code snippet within an interactive environment (likely Jupyter or IPython), labeled as cell `[14]`.

The code consists of three lines:
1.  `import json`: Imports the `json` module.
2.  `my_response = {"answer": "26272"}`: Defines a dictionary named `my_response` containing a single key-value pair where the key is "answer" and the value is the string "26272".
3.  `print(my_response["answer"])`: Prints the value associated with the key "answer" from the `my_response` dictionary.

The output directly below the code, preceded by an output icon, is `26272`.
image514×193 3.61 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/8/4/848f46d75a3912b4ccc280a7594136401c0f0c36.png)
...
> **Image Description**: The image displays a Python script, likely within an interactive development environment.

The script includes:
*   An `import json` statement.
*   A variable `my_response` assigned to a multi-line string. This string contains a JSON object where the value associated with the key `"answer"` is a heavily escaped Python code string.

The embedded Python code string defines:
*   An `import httpx` statement.
*   A function `analyze_sentiment()` that constructs and sends an HTTP POST request.
*   The request's URL is `https://api.openai.com/v1/chat/completions`.
*   Request headers include `Authorization` (with a placeholder `dummy_api_key`) and `Content-Type: application/json`.
*   The request body (`data`) specifies the `gpt-4o-mini` model and a list of messages.
*   Messages include a system prompt to "Analyze the sentiment of the given text and classify it as GOOD, BAD, or NEUTRAL." and a user message containing an alphanumeric string ("P5I 3P1xw aE WvYHB6zc5xB sY4QzV 0bm8TDP7e o MOG4R9").
*   Error handling (`raise_for_status()`) and JSON parsing (`response.json()`) are included for the API response.
*   The function returns the parsed API result.
*   A standard `if __name__ == "__main__":` block executes the `analyze_sentiment()` function, attempts to print its result, and includes basic exception handling to print an error if one occurs.

The final visible line of code outside the `my_response` string is `print(json.loads(my_response)["answer"])`, which attempts to parse the `my_response` string as JSON and print the extracted Python code string.
image927×466 20.8 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/a/e/ae62c221a5f66faaa47d8b10c00b733a7b617d64.png)
...
> **Image Description**: The image displays a Python code snippet within an interactive development environment. The code begins by importing the `json` module. It then defines a dictionary named `my_response` containing a single key, `"answer"`, whose value is a multi-line, escaped string representing a complete Python script.

This embedded script includes the following elements:
*   Import of the `httpx` library.
*   Definition of a function `analyze_sentiment()` designed to interact with the OpenAI API.
*   Configuration for an API call to `https://api.openai.com/v1/chat/completions`, specifying `gpt-4o-mini` as the model.
*   Headers for the API request, including `Authorization` and `Content-Type`.
*   A JSON payload for the API call, containing a `system` message for sentiment analysis (classifying text as GOOD, BAD, or NEUTRAL) and a `user` message with a sample string.
*   Logic to send a POST request using `httpx`, raise an error for unsuccessful HTTP statuses, parse the JSON response, and return the result.
*   A standard Python `if __name__ == "__main__":` block that attempts to call `analyze_sentiment()` and print its result, with an `except` block to catch and print any exceptions.

The outer Python code concludes by printing the entire string value stored in `my_response["answer"]`.
image984×476 19.7 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/f/8/f80d8908109db818e5664f5565bf0a6006055001.png)

---

### Post #158 by Trebhuvan SB on 2025-03-29T06:48:44.746Z
...
### Post #159 by Pradeep Mondal on 2025-03-29T06:57:41.693Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/159

[@Saransh_Saini](/u/saransh_saini)
 the field name “file” would remain same, I mean it won’t be “files” right?

---

### Post #160 by Ripusudan Kumar Jha  on 2025-03-29T09:51:40.049Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/160

I am trying to create a student account on Microsoft Azure using my IIT Madras email ID (
23f2004705@ds.study.iitm.ac.in
), but I am encountering an issue. The system is showing a message that my email domain is not currently registered with them, and it is asking me to use another verification method.

[@carlton](/u/carlton)

[@Jivraj](/u/jivraj)
 Could you please guide me on how to proceed with the verification or if there is an alternative method to access Azure’s student benefits?
...
> **Image Description**: The image displays a Microsoft Azure webpage detailing an "Academic Verification" process. A banner at the top indicates, "Your email domain is not currently registered with us. You can choose another verification method." Below this, the "Academic Verification" section instructs the user to "Start by entering your name as per the school records. Select your school's country and enter your school's name. Enter your date of birth as per the school records. The email address may be used to reach you if we have trouble verifying your application, so please enter your school provided email address." The top right of the page shows an email address, "2312004705@ds.study.iitm.ac.in," and a "Sign out" link.
Screenshot 2025-03-29 1458011891×451 158 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/9/f/9f0e2072693618d5cd332ef83c26690fdcdcf688.png)

---

### Post #161 by Aayush Krishna  on 2025-03-29T09:57:08.697Z
...
### Post #162 by Shashikumar Kohir on 2025-03-29T10:30:07.020Z
...
> **Image Description**: The image displays an "Academic Verification" web form. At the top, a banner states, "Your email domain is not currently registered with us. You can choose another verification method." The form includes an introductory paragraph detailing the information required for verification.

The form fields are:
- **First name**: An input box pre-filled with "shashikumar".
- **Last name**: An empty input box, with a red error message "This field is required" displayed below it.
- **Country**: A dropdown menu with "India" currently selected. Below this, text reads: "If your country is not listed, the offer is not available in your region. Learn More".
- **School name**: An input box pre-filled with "Indian Institute Of Technology Madras (Chennai, Tamil Nadu)". Supplementary text below indicates: "School name will help provide Microsoft with additional information for verification. If available, please enter it here."
- **Date of birth**: A label for this field is visible, but the input area itself is largely cropped from the bottom of the image.
tds972×906 12.2 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/6/2/62ee0c46d695fa20ee1b8f1f3db4569eb27c6751.png)

---

### Post #163 by Pritul Santosh Raut  on 2025-03-29T10:42:53.631Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/163

In Web Scrapping Question The Website will change or it will be same website but the parameters will change of scrapping?
[@Saransh_Saini](/u/saransh_saini)
...
### Post #164 by Shashikumar Kohir on 2025-03-29T11:08:48.881Z
...
### Post #165 by Peter Paul Pooppally on 2025-03-29T11:30:48.076Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/165

Was the project hosting session recording posted? Carlton sir said he would post it.
[@carlton](/u/carlton)

---

### Post #166 by Saransh Saini on 2025-03-29T14:47:50.235Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/166

Hi
[@lakshaygarg654](/u/lakshaygarg654)

In both the scenarios you laid out, the second implementation is correct. Your response to our API request should be a JSON object
{"answer" : "YOUR RESPONSE AS STRING"}
...
### Post #167 by Saransh Saini on 2025-03-29T14:49:52.418Z
...
### Post #168 by Saransh Saini on 2025-03-29T14:57:58.480Z
...
NOTE
: This is not the evaluation script.

---

### Post #169 by Saransh Saini on 2025-03-29T15:08:10.119Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/169

HI
[@ripusudan](/u/ripusudan)
...
### Post #170 by Saransh Saini on 2025-03-29T16:33:31.714Z
...
### Post #171 by Pradeep Mondal on 2025-03-29T16:35:24.959Z
...
### Post #173 by Shivaditya Bhattacharya on 2025-03-29T22:01:16.469Z
...
Q13 - Use GitHub: Since the parameter is just my email, this question
WILL NOT
 be tested against any other email, right? So I can just have a repo with my email in it, right?
...
Q3 - Host your portfolio on GitHub Pages, Q7 - Create a GitHub action, Q8 - Push an Image to Docker Hub: Similar to GA1 Q13, these too have my email or roll number as parameter. These too
WILL NOT
 be checked against any other email, right?
...
### Post #174 by Vicky Kumar on 2025-03-29T22:37:00.167Z
...
### Post #175 by Rajalakshmi Rathinasabhapathy on 2025-03-29T22:38:39.118Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/175

Hello
[@22f3001307](/u/22f3001307)
, there is an error in the code that needs to be fixed as part of the question:
...
### Post #176 by Ripusudan Kumar Jha  on 2025-03-30T00:52:30.182Z
...
### Post #177 by LAKSHAY on 2025-03-30T03:04:53.579Z
...
And asked same doubt,
[@Jivraj](/u/jivraj)
 said 1st implementation they will use.
![:sweat_smile:](https://emoji.discourse-cdn.com/google/sweat_smile.png?v=14)

[Session link](https://drive.google.com/file/d/1ftan66I-2BlfDzVkOfdQcyeTwEXZM8wD/view?usp=drivesdk)
 ( watch at 26:55)
...
### Post #178 by Saransh Saini on 2025-03-30T05:45:35.766Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/178

What Jivraj agreed was stringifying the answer and putting it in as the value of the
"answer"
...
> **Image Description**: The image displays an assignment instruction specifying that responses must be a JSON object containing a single text (string) field named "answer". This instruction is highlighted in yellow. Below the instruction, a JSON code block provides an example of the required format: `{"answer": "1234567890"}`. The code block is labeled "json" in its top right corner.
image1022×277 11.6 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/9/7/97431e22657cc9a42adad103a6f319aa037f9bf3.png)

---

### Post #179 by Saransh Saini on 2025-03-30T05:47:05.448Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/179

[@Jivraj](/u/jivraj)
 kindly add-in your thoughts on this.

---

### Post #180 by Jivraj Singh Shekhawat on 2025-03-30T05:57:55.165Z
...
### Post #181 by Jivraj Singh Shekhawat on 2025-03-30T06:24:57.450Z
...
httpx
 to send a POST request to OpenAI’s API to analyze the sentiment of this (meaningless) text into GOOD, BAD or NEUTRAL. Specifically:
...
The second message must be
exactly
 the text contained above.
...
: This uses a dummy
httpx
 library, not the real one. You can only use:
...
### Post #182 by Shivaditya Bhattacharya on 2025-03-30T06:40:37.786Z
...
### Post #183 by umra on 2025-03-30T07:17:00.486Z
...
When i hit  request on this (curl -X POST “
...
### Post #184 by LAKSHAY on 2025-03-30T07:29:29.032Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/184

As per the portal, we have to return a JSON object as a response from the API. However, if we load a JSON object directly using
json.load()
, it will throw an error. We need to first convert it into a JSON string and then load it using
json.loads( )
. For clarity I add image below.
...
> **Image Description**: The image displays two Python code blocks executed in an IPython environment, demonstrating the correct and incorrect usage of the `json` module's `loads` function.

The first code block defines a Python dictionary `my_response` and attempts to parse it directly using `json.loads(my_response)`. This results in a `TypeError` traceback, specifically stating "TypeError: the JSON object must be str, bytes or bytearray", indicating that `json.loads()` expects a string, bytes, or bytearray, not a Python dictionary.

The second code block shows the corrected approach. It redefines `my_response` as a Python dictionary. A comment `#converting json object to string as "{\"answer\": \"26272\}"` explains the next step. It then correctly converts the Python dictionary into a JSON formatted string using `my_response = json.dumps(my_response)`. Finally, `json.loads()` is called on this JSON string, successfully parsing it and extracting the value associated with the "answer" key, which is `26272`.
image562×700 23.4 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/e/8/e82e8179f7619de01201d2c52d72b62aedcb369c.png)

---

### Post #185 by Durga Prasad on 2025-03-30T07:56:14.480Z
...
### Post #186 by DIGVIJAYSINH SANDEEPSINH CHUDASAMA on 2025-03-30T09:19:40.261Z
...
### Post #187 by Sujay D on 2025-03-30T09:59:07.453Z
...
> **Image Description**: The image displays a set of instructions titled "Your Task" for retrieving and formatting movie data.
...
3.  **Format:** For up to the first 25 titles, extract the ID, title, year, and rating. The movie ID is defined as the part of the URL after `tt` in the `href` attribute (e.g., `tt10078772`). The data must be organized into a JSON array of objects, with each object containing "id", "title", "year", and "rating" keys. An example JSON structure shows:
    ```json
    [
    ...
    ```
4.  **Submit:** Submit the generated JSON data in a provided text box.
image698×405 17.4 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/b/1/b1f766eb39c63ca0fa7f18224692d10600f5d407.png)
...
> **Image Description**: The image displays a JavaScript code snippet primarily focused on web scraping and data extraction. The code defines an asynchronous function that attempts to fetch HTML content from IMDb via a proxy, specifically searching for titles based on user ratings. It includes error handling for the `fetch` request, throwing an error if the data cannot be retrieved.

Upon successful retrieval, a `DOMParser` is used to parse the HTML string. The parsed document is then queried using `querySelectorAll` to select elements representing "summary items." A `map` function iterates over these items to extract specific data:
*   An `id` (likely an IMDb title ID) from the `href` attribute of a link wrapper, using a regular expression.
*   The `title` from elements with the class `ipc-title__text`.
*   The `year` (or similar metadata) from elements with the class `dli-title-metadata-item`.
*   The `rating` from elements with the class `ipc-rating-star--rating`.

Each extracted set of data is returned as an object containing `id`, `title`, `year`, and `rating` properties. A commented or unexecuted line at the top shows a sample JSON-like structure for "The White Lotus," indicating the expected data format.
image733×201 38.2 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/e/0/e010f5c327843dec9c8f355ca5bc35830300c3f8.jpeg)
...
[@carlton](/u/carlton)
 sir because of this mismatch we have to edit manually after clicking check button again and again

please guide me how to solve this

---

### Post #188 by Shivaditya Bhattacharya on 2025-03-30T10:44:49.743Z
...
[@Jivraj](/u/jivraj)
 I just wanted to bring to your attention that in GA4 question 2, the answer evaluation script expects the movie title as “17. Kraven: The Hunter” but it is actually listed on the IMDb page as “17. Kraven the Hunter”, resulting in the correct one being marked wrong.

No questions here just wanted to bring it to attention so that it does not affect the project evaluation script.

---

### Post #189 by Saransh Saini on 2025-03-30T11:21:25.407Z
...
Remove unused libraries from your
requirements.txt
. Sometimes having resource demanding libraries like
SentenceTransformers
 can install large sub-dependency packages.

Exclude your virtual environment folder from the container creation

Create a
.containerignore
 file to have an exception for those folders you want to skip.

Clear your package cache and any vscode cache you might have.

---

### Post #190 by Saransh Saini on 2025-03-30T11:25:59.076Z
...
### Post #191 by Shalini Saravanan on 2025-03-30T13:33:47.907Z
...
> **Image Description**: The image displays a Swagger UI interface for an API endpoint named `POST /api/Upload Csv`. This endpoint is designed to accept a CSV file and return student data, with optional class filters applied via query parameters.

**Key visible elements include:**

*   **Endpoint Description:** "Accept a CSV file and return student data. Optional class filters via query string: `/api?class=1A&class=1B`."
*   **Parameters Section:**
    *   A `class` parameter of type `array[string]` is defined as a query parameter.
    *   Currently, two values, `1A` and `1B`, are provided for the `class` parameter.
*   **Request Body Section:**
    *   The `Request body` is set to `multipart/form-data`.
    *   A required `file` parameter (binary string) has `testapi.csv` selected.
*   **Action Buttons:** "Execute," "Cancel," "Reset," and "Clear" buttons are present, along with a blue progress bar.
*   **Responses Section:**
    *   **Curl Command:** A `curl -X POST` command is generated, showing the full request: `curl -X POST 'https://bhcc-223-178-84-149.ngrok-free.app/api?class=1A&class=1B' -H 'Accept: application/json' -H 'Content-Type: multipart/form-data' -F 'file=@testapi.csv;type=text/csv'`.
    *   **Request URL:** The constructed URL is `https://bhcc-223-178-84-149.ngrok-free.app/api?class=1A&class=1B`.
    *   **Server Response:**
        *   **Code:** `200` (indicating a successful request).
        *   **Response body (JSON):** Contains a `students` array with objects, each having `studentId` and `class` fields (e.g., `{"studentId": 233, "class": "1B"}`, `{"studentId": 344, "class": "1A"}`).
image1932×1748 225 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/3/e/3e7a25395a022241598f1dadada2c71d31ae491e.png)
...
### Post #192 by Shivaditya Bhattacharya on 2025-03-30T14:00:31.751Z
...
> **Image Description**: The image displays a prompt for a data retrieval task, likely for a "Tools in Data Science" course. It includes a question asking for the ISO 8601 formatted date when the newest user joined GitHub. Below the question is an input field for the answer. Further instructions specify the methodology for finding this date:
*   Search using `location:` and `followers:` as filters.
*   Sort the results by `joined` in descending order.
*   Fetch the first `url` from the sorted results.
*   Extract the `created_at` field from the fetched user's data.
*   A constraint is given to ignore users who joined after `3/30/2025, 7:21:18 PM`.
image1602×275 34.1 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/9/1/912aea18fd5f3ba6ceaa9ee01db45fe4b90932cd.png)
...
### Post #193 by Saransh Saini on 2025-03-30T14:54:39.656Z
...
### Post #194 by Saransh Saini on 2025-03-30T15:27:51.667Z
...
### Post #195 by DIGVIJAYSINH SANDEEPSINH CHUDASAMA on 2025-03-30T15:28:05.675Z
...
### Post #196 by Sarang Tambe on 2025-03-30T16:19:01.809Z
...
### Post #197 by Vinil on 2025-03-30T17:06:06.957Z
...
### Post #198 by Harsh jayswal on 2025-03-30T17:08:00.391Z
...
### Post #199 by SUNAY LAHIRI on 2025-03-30T17:08:34.949Z
...
### Post #200 by SAKSHI PATHAK on 2025-03-30T17:08:50.206Z
...
### Post #201 by ABHIJEET KUMAR  on 2025-03-30T17:09:49.008Z
...
### Post #202 by Vicky Kumar on 2025-03-30T18:36:45.249Z
...
### Post #203 by Saransh Saini on 2025-03-30T18:37:46.661Z
...
### Post #204 by Vicky Kumar on 2025-03-30T18:41:02.357Z
...
> **Image Description**: The image displays a futuristic cityscape at dusk or night, characterized by tall buildings with glowing neon-blue and purple lights. Elevated roadways feature streaks of pink and light-blue light, indicating moving vehicles. Several flying vehicles with illuminated components are visible in the sky. No code, question statements, commands, graphs, or tables are present.
reconstructed_jigsaw500×500 476 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/c/2/c24da9c6f92ce75b74b1bfada887edbf2335fafd.png)
...
### Post #205 by Saransh Saini on 2025-03-30T18:48:14.413Z
...
### Post #206 by Vicky Kumar on 2025-03-30T18:51:29.134Z
...
### Post #207 by Saransh Saini on 2025-03-30T18:51:45.855Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/207

[@Algsoch](/u/algsoch)
 We should receive your images as base64 encoded within your response JSON object.

---

### Post #208 by Saransh Saini on 2025-03-30T18:53:35.190Z
...
### Post #209 by Vicky Kumar on 2025-03-30T18:57:21.965Z
...
### Post #210 by Shivaditya Bhattacharya on 2025-03-30T23:47:44.092Z
...
What is the number of successful GET requests for pages under
/telugu/
 from
11:00
 until before
...
For this, I have used two python scripts to get the answer, one written completely by me and another from someone else’s solution; both give the same answer -
2698
...
I had extracted and uploaded the
data
 after extraction using gzip into colab and then executed the script.
...
### Post #211 by VIKASH PRASAD on 2025-03-31T00:52:32.760Z
...
> **Image Description**: The image displays a web form for "Academic Verification." A prominent banner at the top states, "Your email domain is not currently registered with us. You can choose another verification method." Below this, the section heading "Academic Verification" is visible, along with an introductory paragraph instructing the user to enter their name, school's country, school's name, and date of birth as per school records, and to provide a school-provided email address for verification purposes.

The form includes the following input fields with pre-filled values:
- "First name": VIKASH
- "Last name": PRASAD
- "Country": India (selected from a dropdown menu)
- "School name": Indian Institute Of Technology Madras (Chennai, Tamil Nadu)

Below the "Country" field, there is a note: "If your country is not listed, the offer is not available in your region. Learn More." A partial sentence below the "School name" field reads: "School name will help provide Microsoft with additional information for verification. If available, please enter it here."
Screenshot 2025-03-31 0645381172×815 101 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/5/4/54ccbabc6319ac27f5ea3495a8e4224c9104c87b.png)
...
> **Image Description**: The image displays a user interface element for entering an email address. It features the text label "School email address" above an input field. The input field contains the pre-filled email address "21f3002277@ds.study.iitm.ac.in".
Screenshot 2025-03-31 064552913×119 3.63 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/5/c/5caf6ab37f4494ba32c8d50ccfae06cf4004990f.png)

---

### Post #212 by Durga Prasad on 2025-03-31T02:12:41.365Z
...
### Post #213 by Parmeet Singh on 2025-03-31T02:35:29.417Z
...
### Post #214 by VIKASH PRASAD on 2025-03-31T02:59:23.551Z
...
> **Image Description**: The image displays a user interface for configuring "Inbound port rules" for a virtual machine. A descriptive text explains the purpose: to select which VM network ports are accessible from the public internet, noting that more granular control is available on a "Networking tab."

Under "Public inbound ports," two radio button options are presented: "None" and "Allow selected ports." "Allow selected ports" is currently chosen.

Below this, a "Select inbound ports" section contains a dropdown menu showing "SSH (22)."

A warning box is prominently displayed, stating: "This will allow all IP addresses to access your virtual machine. This is only recommended for testing. Use the Advanced controls in the Networking tab to create rules to limit inbound traffic to known IP addresses."
Screenshot 2025-03-31 0748451267×351 16.2 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/7/0/702ca0c1c6718016588008430a88c204d85447ed.png)

is the port is correct
[@Jivraj](/u/jivraj)

---

### Post #215 by LAKSHAY on 2025-03-31T03:31:01.373Z
...
### Post #216 by SAKSHI PATHAK on 2025-03-31T03:35:17.574Z
...
### Post #217 by SUNAY LAHIRI on 2025-03-31T04:03:08.650Z
...
### Post #218 by Mohd Atif on 2025-03-31T04:42:18.307Z
...
### Post #219 by Shouvik Roy  on 2025-03-31T04:51:01.571Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/219

[@carlton](/u/carlton)
, please this much support we deserve from you

---

### Post #220 by Lakshika Sheoran on 2025-03-31T04:52:58.540Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/220

Pls sir extend the deadline it’s very hectic schedule for all of us  to complete by today.
[@Jivraj](/u/jivraj)
...
### Post #221 by Md anas alam on 2025-03-31T05:02:37.667Z
...
### Post #222 by Vidushi Singh on 2025-03-31T05:17:03.447Z
...
### Post #223 by Aashutosh on 2025-03-31T05:46:21.171Z
...
### Post #224 by Vicky Kumar on 2025-03-31T06:00:34.319Z
...
### Post #226 by Gursimar Singh Miglani on 2025-03-31T06:53:04.484Z
...
### Post #227 by Shivaditya Bhattacharya on 2025-03-31T07:23:38.044Z
...
### Post #228 by Trebhuvan SB on 2025-03-31T07:42:54.921Z
...
[http://ip](http://ip)
:port/endpoint. But while testing using the portal it expects HTTPS instead of http. But nothing of that sort is given in the question. Will the evaluator also expect a https url or is a http url enough for it to hit the endpoint?
...
### Post #230 by Saransh Saini on 2025-03-31T08:54:56.530Z
...
### Post #231 by MOHIT KUMAR on 2025-03-31T09:01:12.431Z
...
### Post #232 by PREMDEEP MAITI on 2025-03-31T09:01:50.464Z
...
### Post #233 by PREMDEEP MAITI on 2025-03-31T09:04:15.646Z
...
> **Image Description**: The image displays instructions for a data science task involving Vercel deployment and API development. Key elements include:

*   An instruction to download `q-vercel-python.json`, described as containing marks for 100 imaginary students.
*   A task to create and deploy a Python application to Vercel.
*   A requirement to expose an API endpoint that, when queried with multiple `name` parameters (e.g., `https://your-app.vercel.app/api?name=X&name=Y`), returns a JSON response containing the marks for the specified names in the given order.
*   An example JSON output: `{"marks": [10, 20]}`.
*   A directive to enable CORS for GET requests from any origin.
*   A question asking for the Vercel URL format (`https://your-app.vercel.app/api`).
*   A text input field showing a sample Vercel URL: `https://vercel-tds-one.vercel.app/api`.
image1548×391 39.2 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/a/e/ae3db1558c1c853137da1bcaead90e53cd7b3e0e.png)
...
> **Image Description**: The image displays text-based instructions and a question, followed by an answer. The instructions involve downloading "Llamafile" and running a "Llama-3.2-1B-Instruct.Q6_K.llamafile" model. It then instructs to create a tunnel to the Llamafile server using "ngrok." A question asks for the ngrok URL, providing an example format (`https://[random].ngrok-free.app/`). The answer to this question is displayed in a text box: `https://aafb-2405-201-4007-c068-eb1d-b640-5d42-2493.ngrok-free.app`.
image780×221 21.5 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d/7/d7cac5f5c3125be67b63fec21c325396bc97a549.png)

---

### Post #234 by Vicky Kumar on 2025-03-31T09:35:03.763Z
...
> **Image Description**: The image displays a user interface element with text instructions and an interactive component. The top line of text states: "Just above this paragraph, there's a hidden input with a secret value." Below this, a question is posed: "What is the value in the hidden input?" Directly underneath the question is an empty rectangular text input field, followed by a blue button labeled "Check".
image788×325 9.21 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/2/3/23abb4f175b7f92848319f114c914802eeef968b.png)

---

### Post #235 by Vicky Kumar on 2025-03-31T09:40:34.965Z
...
> **Image Description**: The image displays a web-based interactive prompt designed to test knowledge of CSS selectors. The main instruction reads: "Let's make sure you know how to select elements using CSS selectors. Find all `<div>`s having a `foo` class in the hidden element below. What's the sum of their `data-value` attributes?"

Below this question, an empty input field is labeled "Sum of data-value attributes:", indicating where the user should enter their answer. A blue "Check" button is positioned beneath the input field, likely for submitting the answer for validation. The "hidden element below" refers to content not visible in the provided image.
image974×281 14.5 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/9/0/90ea58e29491f8701df814f3d251eaed4ba8b511.png)

---

### Post #236 by PREMDEEP MAITI on 2025-03-31T09:44:56.942Z
...
### Post #237 by Vicky Kumar on 2025-03-31T09:47:14.170Z
...
> **Image Description**: The image displays a data science problem involving a SQLite database table named `tickets`. The problem description states the `tickets` table has three columns: `type`, `units`, and `price`, where each row represents a customer bid for a concert ticket.

Below the description, a sample portion of the `tickets` table is visible, showing five rows of data. The visible data includes varied casing for the `type` column (e.g., 'bronze', 'Bronze', 'Silver', 'SILVER'), alongside corresponding `units` and `price` values. An ellipsis indicates that more rows exist in the table.

Following the table, a question is posed: "What is the total sales of all the items in the 'Gold' ticket type? Write SQL to calculate it." An empty, dark rectangular area is provided beneath this question, presumably for the SQL query input or output.
image859×556 23 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/6/c/6c19d7b5ba8e0b48d16f52f1076797b58adbcdda.png)

do you know answer of this that time i got answer

---

### Post #238 by Vicky Kumar on 2025-03-31T09:47:39.835Z
...
### Post #239 by LAKSHAY on 2025-03-31T10:06:21.260Z
...
### Post #240 by Sengathirsoorian E T on 2025-03-31T10:10:44.561Z
...
> **Image Description**: The image displays the user interface of an "AI Assignment Solver" application. The interface is structured with a main title and two functional sections. The first section, labeled "Upload a File," contains a "Choose File" button, an adjacent text display indicating "No file chosen," an "Upload" button, and a status message "No file uploaded." The second section, labeled "Ask a Question," features a text input field with the placeholder "Enter your question here," a "Submit" button, and an output display area with the placeholder "Answer will appear here."
image439×459 28.4 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/3/4/345451fd5cce567ffc8d8a5a36c17cf144e049c5.png)
...
### Post #241 by Sengathirsoorian E T on 2025-03-31T10:20:37.301Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/241

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/4/8/4814907cdcba8ac45921a9b27f50883ecbcde10c.png)image643×576 36.1 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/4/8/4814907cdcba8ac45921a9b27f50883ecbcde10c.png)
...
[Project 2 - TDS Solver - Discussion Thread - #240](https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/240)

---

### Post #242 by Saransh Saini on 2025-03-31T10:34:51.168Z
...
We appreciate the efforts you have put in. But, for the project we aren’t expecting a full-stack app with an integrated frontend. We just need an API endpoint on which we would be able to send requests in the given format. For more info check the TDS course page.
[Tools in Data Science](https://tds.s-anand.net/#/project-2)

---

### Post #243 by Harsh Jaiswal on 2025-03-31T10:42:25.636Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/243

[@Saransh_Saini](/u/saransh_saini)
 Is answer in this form acceptable..

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/2/1/214f621511c83fa1983bcab693d2e00a5de2564a_2_690x376.png)image2726×1489 463 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/2/1/214f621511c83fa1983bcab693d2e00a5de2564a.png)

---

### Post #244 by VIKASH PRASAD on 2025-03-31T10:51:38.767Z
...
### Post #245 by Sahil Raj  on 2025-03-31T11:11:00.092Z
...
> **Image Description**: This image displays a web service deployment interface for "TDS-Project-2," which is a Python 3 application currently on a "Free" tier. The service is linked to the GitHub repository "2313001764/TDS-Project-2" and deployed from the "main" branch, with its live URL being "https://tds-project-2-pnlm.onrender.com".

A prominent notification alerts that the free instance will spin down with inactivity, potentially delaying requests by 50 seconds or more, with an "Upgrade now" option. The current deployment status indicates an operation "In Progress," initiated on "March 31, 2025 at 4:38 PM," corresponding to the commit "5989351 Final Commit." A "Cancel deploy" button is available.

Further controls include "Connect" and "Manual Deploy" options. Below the deployment status, there is an interface for viewing logs, featuring an "All logs" dropdown, a "Search" bar, a "Live tail" function, and a timezone selector set to "GMT+5:30."
image1454×433 30.4 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/0/6/061c7cd1be2fa69ae6ce13bb706c938540441bac.png)

I have deployed the project on render so the first request in evaluation takes around 50 to 60 second is that okay

---

### Post #246 by Lovepreet Singh on 2025-03-31T11:14:44.705Z
...
.up.railway.app
. I tested it with five other ISPs, and the API endpoint works perfectly. Could you please consider that some ISPs may be blocking certain domains?
...
### Post #247 by Kartikay Taunk on 2025-03-31T11:32:36.061Z
...
### Post #248 by Sahil Raj  on 2025-03-31T12:02:41.780Z
...
### Post #249 by Aarush saxena  on 2025-03-31T12:23:14.636Z
...
### Post #250 by Parthiv on 2025-03-31T12:53:01.396Z
...
### Post #251 by Saransh Saini on 2025-03-31T13:11:58.346Z
...
### Post #252 by Saransh Saini on 2025-03-31T13:16:16.859Z
...
### Post #253 by Vishal Baraiya on 2025-03-31T13:26:00.701Z
...
### Post #254 by Jivraj Singh Shekhawat on 2025-03-31T13:30:11.134Z
...
### Post #256 by Vishal Baraiya on 2025-03-31T13:36:44.642Z
...
### Post #257 by MOHIT KUMAR on 2025-03-31T14:10:05.571Z
...
### Post #258 by Vishal Baraiya on 2025-03-31T14:15:27.489Z
...
### Post #259 by Swati Kapoor on 2025-03-31T14:17:32.957Z
...
### Post #260 by Nihar Panse on 2025-03-31T14:20:23.884Z
...
### Post #261 by NamanBeri on 2025-03-31T14:41:40.040Z
...
> **Image Description**: The image displays a web page showing a serverless function error. The top section indicates the status of three components: "This Serverless Function has crashed," "Your connection is working correctly," and "Vercel is working correctly." A prominent box details the error as "500: INTERNAL_SERVER_ERROR" with a "Code: `FUNCTION_INVOCATION_FAILED`" and an "ID: `bom1::48ghr-1743430791127-d99a1b77819a`". Below this, instructions are provided for both visitors ("contact the website owner or try again later") and owners ("learn how to fix the error and check the logs").
image717×572 25.9 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/3/0/305235a24932cb3f94ca76430d58fe8106f0d2ee.png)

---

### Post #262 by Neelakandan R on 2025-03-31T15:00:04.920Z
...
### Post #263 by Arun  P on 2025-03-31T15:01:08.449Z
...
### Post #264 by Gursimar Singh Miglani on 2025-03-31T15:08:14.274Z
...
### Post #265 by Andrew David on 2025-03-31T15:19:51.532Z
...
### Post #266 by Andrew David on 2025-03-31T15:24:31.903Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/266

Sometimes the server shuts down, what would happen then?
[@Jivraj](/u/jivraj)
...
### Post #267 by Saransh Saini on 2025-03-31T15:33:24.325Z
...
### Post #268 by Bhargav Chavda on 2025-03-31T15:53:03.974Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/268

[@Saransh_Saini](/u/saransh_saini)
 can you provide us the time frame for evaluation so that we know when to run ngrok. Vercel isn’t an option right now as i’m having issues deploying.

---

### Post #269 by Md anas alam on 2025-03-31T16:05:20.764Z
...
### Post #270 by Andrew David on 2025-03-31T16:18:49.728Z
...
### Post #271 by Peter Paul Pooppally on 2025-03-31T16:22:45.253Z
...
### Post #272 by Aarush saxena  on 2025-03-31T16:39:40.305Z
...
### Post #273 by Andrew David on 2025-03-31T17:27:18.896Z
...
### Post #274 by Parthiv on 2025-03-31T17:59:05.230Z
...
### Post #275 by Parthiv on 2025-03-31T18:00:46.035Z
...
### Post #276 by Vidushi Singh on 2025-03-31T18:02:07.401Z
...
### Post #277 by Parthiv on 2025-03-31T18:02:52.046Z
...
### Post #278 by Vicky Kumar on 2025-03-31T18:13:24.009Z
...
### Post #279 by Sahil Raj  on 2025-03-31T18:13:58.736Z
...
### Post #280 by Vicky Kumar on 2025-03-31T18:16:05.830Z
...
### Post #281 by Yashvardhan on 2025-03-31T18:17:52.354Z
...
### Post #282 by Parthiv on 2025-03-31T18:22:03.328Z
...
### Post #283 by Vinil on 2025-03-31T18:25:10.973Z
...
### Post #284 by Tushar Jalan  on 2025-03-31T18:28:51.346Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/284

yes me too

Thank You for some sleepless nights(now I have some dark-circles😑) and this wonderful experience
[@s.anand](/u/s.anand)
...
### Post #286 by Andrew David on 2025-03-31T18:30:21.763Z
...
### Post #287 by Aarush saxena  on 2025-03-31T18:34:14.893Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/287

Ah, the true mark of a dedicated developer—when even your dreams come with syntax errors!
![:laughing:](https://emoji.discourse-cdn.com/google/laughing.png?v=14)
 This project was a rollercoaster of caffeine, code, and existential debugging at 3 AM. But hey, we survived, and now even my subconscious is running
python main.py
 on repeat. On to the next adventure… after some well-earned sleep (hopefully bug-free)!

---

### Post #288 by Saksham on 2025-03-31T18:38:30.881Z
...
> **Image Description**: The image displays a close-up of a cat with grey and white tabby markings, standing on its hind legs. Its front paws are positioned near its mouth, suggesting a contemplative or "shushing" gesture. The background is a solid, light brown color, possibly a wooden floor or wall. No code, question statements, commands, graphs, or tables are visible in the image.
image417×406 31 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d
Why did I fail?

[](#p-614585-last-term-4)
Last Term
...
[](#p-614585-me-understanding-about-the-course-now-6)
...
SKLearn
. Then I practiced and got 90 in the second OPPE.

This course has made me realise that till I need to learn relearn these things in an
implicit
 way.
...
### Post #316 by Parthiv on 2025-04-02T14:21:36.079Z
...
### Post #317 by Harsh jayswal on 2025-04-02T14:34:43.238Z
...
### Post #318 by ABHIJEET KUMAR  on 2025-04-02T14:37:04.508Z
...
### Post #319 by Carlton D'Silva on 2025-04-02T14:52:16.536Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/319

[@parthivn28](/u/parthivn28)

[@Harshjayswal-2003](/u/harshjayswal-2003)
...
### Post #320 by ABHIJEET KUMAR  on 2025-04-02T15:09:04.625Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/320

[@carlton](/u/carlton)
 lord carlton
![:ok_hand:](https://emoji.discourse-cdn.com/google/ok_hand.png?v=14)

---

### Post #321 by Sonal Raikar on 2025-04-02T18:24:37.998Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/321

Yess, I too did the same , previously submitted on 11.55 and edited my response on 12.01 with /api . Hope u will consider it .
[@carlton](/u/carlton)
...
### Post #322 by Vicky Kumar on 2025-04-03T03:34:41.099Z
...
### Post #323 by DIGVIJAYSINH SANDEEPSINH CHUDASAMA on 2025-04-03T04:50:08.140Z
...
### Post #324 by Shouvik Roy  on 2025-04-03T05:01:59.534Z
...
### Post #325 by SUNAY LAHIRI on 2025-04-03T05:10:40.652Z
...
### Post #326 by Jivraj Singh Shekhawat on 2025-04-03T05:39:46.649Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/326

![](https://dub1.discourse-cdn.com/flex013/user_avatar/discourse.onlinedegree.iitm.ac.in/21f2000588/48/478_2.png)
 21f2000588:
...
### Post #327 by DIGVIJAYSINH SANDEEPSINH CHUDASAMA on 2025-04-03T06:16:26.902Z
...
> **Image Description**: The image displays a user interface for configuring and executing a request, likely an API call.

The top section is labeled "Parameters" and indicates "No parameters".

Below, the "Request body" section is marked "required". It is configured for `multipart/form-data`. Two input fields are present:
*   "question" (string, required): Contains the pre-filled text "Download and use multi-cursors and convert it into a single".
*   "file" (string | string | null | $binary): Includes a "Choose File" button next to "q_multi-cursor.json.txt", indicating a file has been selected. A checkbox labeled "Send empty value" is also visible.

Action buttons include "Execute" (a large blue button), "Clear", "Cancel" (red), and "Reset".

The bottom section is labeled "Responses" with a sub-section "Curl", both currently empty.
image1775×721 21.8 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/9/2/9201a514dc9b85f1bef21a9b90a225754a65072f.png)
...
> **Image Description**: The image displays a server response interface showing an HTTP status code of 200, indicating a successful request. The "Response body" section contains a JSON object. This object includes a single key, "answer", associated with a hexadecimal string value: "7a5955793f63e199d0677d3f0053c581bb665b92532d801ba96c598d724d8". A "Download" button is present to the right of the response body.
image1806×235 10.1 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d/d/dd6c4fed0a92c88924a7bf38b2e19497253fca36.png)

Hope you get my point which i’m trying to convey sir.

---

### Post #328 by Carlton D'Silva on 2025-04-03T06:58:49.996Z
...
### Post #329 by Carlton D'Silva on 2025-04-03T07:01:25.765Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/329

The way we test your api is
not through a front end.
...
### Post #331 by P V SHRAVAN on 2025-04-03T15:00:04.346Z
...
### Post #332 by Aarush saxena  on 2025-04-03T16:18:49.640Z
...
### Post #333 by Yashvardhan on 2025-04-04T06:14:49.255Z
...
### Post #334 by Carlton D'Silva on 2025-04-04T06:15:47.759Z
...
### Post #335 by Carlton D'Silva on 2025-04-04T06:17:36.098Z
...
### Post #336 by Aarush saxena  on 2025-04-04T06:24:18.228Z
...
### Post #337 by Carlton D'Silva on 2025-04-04T06:30:04.973Z
...
[@s.anand](/u/s.anand)
 if its been enabled, i almost certain he has configured it for multiple submissions.

---

### Post #338 by Aarush saxena  on 2025-04-04T06:31:22.509Z
...
### Post #339 by Carlton D'Silva on 2025-04-04T06:31:57.450Z
...
### Post #340 by Aarush saxena  on 2025-04-04T06:32:59.463Z
...
### Post #341 by Vicky Kumar on 2025-04-04T06:37:32.871Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/341

:

[](#p-615157-from-problem-to-platform-building-vicky-a-smart-data-science-assistant-for-tds-iit-madras-1)
...
![:rocket:](https://emoji.discourse-cdn.com/google/rocket.png?v=14)

Project Demo Website
:
[https://app.algsoch.tech](https://app.algsoch.tech)

During our college course
Tool for Data Science (TDS)
 at
IIT Madras
, we were tasked with a challenging but exciting project:
to build a platform that can take in natural language questions and execute corresponding solutions through an API
.

[](#p-615157-the-mission-2)
![:brain:](https://emoji.discourse-cdn.com/google/brain.png?v=14)
 The Mission:

Create a tool that behaves like a
chatbot
, accepts
user queries (text or file-based)
 via
web or API
, processes them intelligently,
executes the appropriate code
, and returns accurate results—like a real data science assistant.

[](#p-615157-the-journey-from-fails-to-final-3)
![:counterclockwise_arrows_button:](https://emoji.discourse-cdn.com/google/counterclockwise_arrows_button.png?v=14)
 The Journey: From Fails to Final

At first, the natural choice was to try
LLM agents
—they sounded magical. But in real-world usage, they were slow, unreliable, and lacked precision. Most failed to parse or execute even moderately dynamic queries.
...
? That quickly broke when users passed
different parameters, different files
, or queried in
non-standard formats
 like “code -s” or “code -v”.

The next idea: write
individual Python scripts per question
 from our Graded Assignments (GA1–GA5). But that lacked flexibility and reusability. Creating multiple files became unmanageable and non-scalable.
![:cross_mark:](https://emoji.discourse-cdn.com/google/cross_mark.png?v=14)

[](#p-615157-the-breakthrough-dynamic-function-mapping-4)
![:wrench:](https://emoji.discourse-cdn.com/google/wrench.png?v=14)
...
![:white_check_mark:](https://emoji.discourse-cdn.com/google/white_check_mark.png?v=14)
 Centralized engine in
vicky_server.py

![:white_check_mark:](https://emoji.discourse-cdn.com/google/white_check_mark.png?v=14)
 Uses
regex-based pattern matching
 to detect question types, extract parameters, and identify the correct solution

![:white_check_mark:](https://emoji.discourse-cdn.com/google/white_check_mark.png?v=14)
 Each solution is a structured Python function like
...
![:white_check_mark:](https://emoji.discourse-cdn.com/google/white_check_mark.png?v=14)
 Acts like a
mini compiler for data science tools

[](#p-615157-presenting-vicky-the-mini-chatbot-for-tds-5)
![:globe_with_meridians:](https://emoji.discourse-cdn.com/google/globe_with_meridians.png?v=14)
 Presenting Vicky – The Mini Chatbot for TDS
![:fire:](https://emoji.discourse-cdn.com/google/fire.png?v=14)

Vicky is a
smart, modular chatbot
 built specifically for
Tool for Data Science at IIT Madras
. It’s packed with real functionality—not just templates.

[](#p-615157-key-features-6)
Key Features:
...
![:open_file_folder:](https://emoji.discourse-cdn.com/google/open_file_folder.png?v=14)
...
![:globe_showing_europe_africa:](https://emoji.discourse-cdn.com/google/globe_showing_europe_africa.png?v=14)
...
![:robot:](https://emoji.discourse-cdn.com/google/robot.png?v=14)

Webhooks Integration

Live notifications via
Discord
 &
Slack
 whenever
...
![:spouting_whale:](https://emoji.discourse-cdn.com/google/spouting_whale.png?v=14)
...
![:chart_increasing:](https://emoji.discourse-cdn.com/google/chart_increasing.png?v=14)

Live Web UI at
[app.algsoch.tech](https://app.algsoch.tech)
...
[](#p-615157-built-with-7)
![:man_technologist:](https://emoji.discourse-cdn.com/google/man_technologist.png?v=14)
 Built With:

FastAPI
 for blazing fast APIs

Regex & Pattern Matching
 for dynamic input detection

GitHub Copilot
 + my Python debugging and architectural thinking
...
### Post #342 by Vicky Kumar on 2025-04-04T06:44:22.248Z
...
### Post #343 by LAKSHAY on 2025-04-04T06:46:41.886Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/343

Hi
[@carlton](/u/carlton)

The same issue has affected several of us. During the last Google Meet session, we explained the situation to
[@Saransh_Saini](/u/saransh_saini)
.
...
### Post #344 by Yashvardhan on 2025-04-04T08:04:29.014Z
...
### Post #345 by Vinil on 2025-04-04T08:52:22.299Z
...
> **Image Description**: The image displays a Microsoft Azure Sponsorships account balance page, accessible via `https://www.microsoftazuresponsorships.com/Balance`. The primary view shows "SPONSORED" status for an active offer expiring in 349 days. A visual and textual breakdown indicates a "TOTAL CREDIT" of 100 USD, with 26 USD "USED" and 74 USD "REMAINING." One "ACTIVE" subscription is listed. The validity period is from 18 March 2025 to 18 March 2026, with usage calculations based through 4 April 2025. The associated account email is 2312004837@ds.study.iitm.ac.in. A right-hand panel titled "Subscription Usage" displays a partial subscription ID (`3def2d44-91a8-495d-81ff`) for an "Azure for Students" subscription. Multiple browser tabs are open, including "Inbox - 2312004837@ds.study.iitm.ac.in," "Azure for Students - Microsoft," and tabs referencing "Project 2 - TDS Solver" and "TDS-Hackers/GASolver."
Screenshot 2025-04-04 at 2.13.30 PM2458×1180 207 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/7/c/7c121ecbbfffc3180e6e7bbe79c667d3d4104535.png)
...
### Post #346 by SP on 2025-04-04T21:57:25.960Z
...
### Post #347 by HARISH. S on 2025-04-05T11:24:02.998Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/347

[@carlton](/u/carlton)
 . Hi sir, I also edited the form after deadline. I just added /ask in the end…

---

### Post #348 by Sarthak Singh Gaur on 2025-04-05T13:37:36.584Z
...
### Post #349 by Parthiv on 2025-04-05T16:56:26.126Z
...
### Post #350 by ABHIJEET KUMAR  on 2025-04-05T17:58:59.692Z
...
> **Image Description**: The image displays a terminal window showing log entries, likely from a web server or application named "TDS python[79249]". Each log line includes a timestamp (date and time), a log level (INFO or WARNING), a source IP address, the HTTP request method (GET, PROPFIND, POST), the requested URI path, the HTTP protocol version, and the HTTP status code with its description (e.g., "200 OK", "404 Not Found", "405 Method Not Allowed"). Notable requested paths include common web assets like `/favicon.ico`, application-specific paths like `/.env`, `/autodiscover/autodiscover.json?@zdi/Powershell`, `/actuator/health`, and `/logincheck`. One entry explicitly notes a "WARNING: Invalid HTTP request received." The bottom of the screen displays a Linux shell prompt: `azureuser@TDS:~$.`
Screenshot 2025-04-05 2323531758×564 57.8 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/f/a/fac3f095316947fa8d5b510bbf9521fa01cdf1ff.png)

something’s cooking…
![:sweat_smile:](https://emoji.discourse-cdn.com/google/sweat_smile.png?v=14)
 And it doesn’t seem like good news for us — at least from the initial visuals.

---

### Post #351 by ABHIJEET KUMAR  on 2025-04-05T18:51:12.099Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/351

[@carlton](/u/carlton)
 I’m noticing frequent requests from globally scattered IPs—mostly from cloud or bulletproof hosts like DigitalOcean, Contabo, and Azure—targeting sensitive paths like
/t4
,
/logincheck
,
...
, and
/.git/config
. These include IPs from places like New York (162.243.238.100), London (34.89.64.89), Amsterdam (45.148.10.172), Moscow (84.201.151.18), Jaipur (103.175.163.104), and Vilnius (85.255.108.243). It really seems like automated vulnerability scanning or botnet activity. Carlton, what can I do??

---

### Post #352 by Saransh Saini on 2025-04-06T04:47:59.351Z
...
### Post #353 by Saransh Saini on 2025-04-06T04:49:41.116Z
...
### Post #354 by Andrew David on 2025-04-06T06:31:16.150Z
...
### Post #355 by Andrew David on 2025-04-06T06:33:11.885Z
...
### Post #356 by Andrew David on 2025-04-06T06:34:51.535Z
...
### Post #357 by Andrew David on 2025-04-06T06:41:00.743Z
...
### Post #358 by Pradeep Mondal on 2025-04-06T07:11:02.137Z
...
[@Saransh_Saini](/u/saransh_saini)
 I too faced the same issue, I received a bunch of hits from random ip addresses and it got shut down.
...
> **Image Description**: The image displays a console output, predominantly featuring log messages. The log entries are prefixed with either "INFO" or "WARNING" levels.

Each "INFO" entry typically includes an IP address followed by a port or timestamp-like numerical sequence, an HTTP request method ("GET" or "POST"), a requested path (e.g., `/manage/account/login`, `/admin/index.html`, `/.env.bak`, `/hudson`), an HTTP protocol version ("HTTP/1.1" or "HTTP/1.0"), and a "404 Not Found" status message.

Multiple "WARNING" messages indicate "Invalid HTTP request received". The log concludes with sequential messages detailing a server shutdown process: "Shutting down", "Waiting for application shutdown.", "Application shutdown complete.", and "Finished server process [1320]". The display uses a dark background with light text.
Screenshot 2025-04-06 at 12.37.36 PM1340×1132 196 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/9/2/92ca930ea02d9e1d06f8929e64d3777d75602b60.jpeg)
...
### Post #359 by Parthiv on 2025-04-06T07:15:25.961Z
...
### Post #360 by Andrew David on 2025-04-06T07:16:49.857Z
...
### Post #361 by Andrew David on 2025-04-06T07:17:25.537Z
...
### Post #362 by Andrew David on 2025-04-06T07:30:53.676Z
...
### Post #363 by Andrew David on 2025-04-06T07:41:08.690Z
...
### Post #364 by Carlton D'Silva on 2025-04-06T08:07:50.000Z
...
### Post #365 by S Smriti on 2025-04-06T08:48:44.696Z
...
![:thinking:](https://emoji.discourse-cdn.com/google/thinking.png?v=14)

---

### Post #366 by Saransh Saini on 2025-04-06T09:33:36.150Z
...
### Post #367 by Carlton D'Silva on 2025-04-06T09:43:51.000Z
...
### Post #368 by Vikram Suriyanarayanan on 2025-04-06T10:58:43.777Z
...
### Post #369 by ABHIJEET KUMAR  on 2025-04-06T11:41:01.602Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/369

[@Carlton](/u/carlton)
, I believe you all have evaluated it. For me, there are some requests from a known IP with the following location details:
...
> **Image Description**: The image displays a terminal screen with system log output and a user prompt.

**Log Output:**
*   Seven lines of log entries are visible, all prefixed with "Apr 06" and timestamps.
*   The first log entry, timestamped "10:10:28", shows "TDS python[79249]: INFO: 103.158.43.17:0 - "GET /favicon.ico HTTP/1.0" 200 OK".
*   The subsequent six log entries, all timestamped "11:08:19", show "TDS python[79249]: INFO: 103.158.43.17:0 - "POST /api HTTP/1.0" 200 OK".
*   The IP address "103.158.43.17" is highlighted in red in the log entries.

**Shell Prompt:**
*   Below the log output, a shell prompt is visible in green text: "azureuser@TDS:~$"
*   A blinking cursor is present immediately after the "$" symbol, indicating readiness for user input.
Screenshot 2025-04-06 1703051231×173 5.14 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/1/3/13f9716cb0274b7528517e12fd041f6bd7717d5e.png)

---

### Post #370 by S Smriti on 2025-04-06T12:06:55.588Z
...
### Post #371 by Saransh Saini on 2025-04-06T13:12:08.467Z
...
### Post #372 by S Smriti on 2025-04-06T13:14:26.103Z
...
> **Image Description**: The image displays an API client interface, likely Postman or a similar tool, showing an HTTP POST request and its response.

**Request Details:**
*   **Method:** POST
*   **URL:** `4.213.61.248:8080/api`
*   **Body Type:** `form-data`
*   **Parameter:** A key-value pair is sent: `question` with the value `what is output of -s?`.
...
*   **Body Format:** JSON
*   **Content:** The JSON response contains a single key, `"answer"`, whose value is a detailed string of system information. This includes:
    *   Software Version: "Code 1.96.2 (fabdb6a30b49f79a7aba0f2ad9df9b399473300f, 2024-12-19T10:22:47.216Z)"
    *   Operating System: "Darwin arm64 24.2.0"
    *   CPU Information: "nCPUs: 8" (from "Apple M1 (8 x 2400)")
    *   Memory: "8.00GB (0.09GB free)"
    *   Load Average: "2, 6"
    *   Various component statuses, such as `2d_canvas: enabled_on`, `gpu_compositing: enabled_on`, `opengl: enabled`, and `rasterization: disabled_off`.
image1337×754 55.1 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/0/5/0590dc73054cb36b3109f0338911fdc231ff0937.png)
...
> **Image Description**: The image displays a terminal output detailing an interaction with a language model API, likely related to a tool or function execution.

Key visible elements:
*   **Function Definition:** A JSON object defines a `solver_1` function. It is described as providing output from a specific command in VS Code and requires a `command` string as a parameter.
*   **API Response:** A large JSON structure represents a `chat.completion` response from the `gpt-4o-mini-2024-07-18` model.
*   **Tool Call:** Within the API response, an `assistant`'s `tool_calls` section shows the `solver_1` function being invoked with the argument `{"command":"-s"}`.
*   **Token Usage and Cost:** The `usage` field details token consumption: 63 prompt tokens, 18 completion tokens, and 81 total tokens. Monetary cost information is also present, including `monthlyCost` and `cost`, along with a `costError` message: `'crypto.createHash is not a function'`.
*   **HTTP Log:** An `INFO` line indicates a successful HTTP POST request to `54.86.50.139:41710/api` with a `200 OK` status.
*   **Command Line:** The bottom line shows a shell prompt `23F2000599@ds.study.iitm.ac.in@TDS-PROJECT:~/tds-solver$` from a user `23F2000599` on a system named `TDS-PROJECT`.
image1914×292 40.3 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/b/6/b648e1445e752d02cebfac10a95e9d507f9a4ad3.png)

---

### Post #373 by S Smriti on 2025-04-06T13:16:47.769Z
...
### Post #374 by Saransh Saini on 2025-04-06T13:19:20.836Z
...
### Post #375 by S Smriti on 2025-04-06T13:19:51.318Z
...
### Post #376 by Tanush Tambe on 2025-04-06T13:28:35.261Z
...
### Post #377 by S Smriti on 2025-04-06T13:40:55.409Z
...
### Post #378 by Saransh Saini on 2025-04-06T13:55:30.851Z
...
### Post #379 by Tanush Tambe on 2025-04-06T13:57:03.880Z
...
### Post #380 by Manit Bohra on 2025-04-06T14:26:15.175Z
...
> **Image Description**: An API client interface displays a POST request to `104.211.116.95:8080/api`. The request body is configured as `form-data`, including a key-value pair where `question` is the key and "Install and run Visual Studio Code. In your Terminal (or..." is the text value.

The response section shows a `200 OK` status, a request duration of `3.86 s`, and a response size of `2.08 KB`. The response body is formatted as JSON, containing an "answer" field. The value of this field appears to be a string of system information, including "Version: Code 1.96.2", "Darwin arm64 24.2.0", "Apple M1" CPU details, "8.00GB" system memory, load averages, and various rendering and GPU status flags such as `gpu_compositing: enabled_on`, `opengl: enabled`, and `video_decode: enabled`. The information also lists process metrics like CPU percentage, memory in MB, PID, and process name.
image1378×866 65 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/7/3/7394a5257884162f7de2da5edebfea971446cd0e.png)
...
> **Image Description**: The image displays an API client interface configured for a POST request.

The request is directed to the endpoint `104.211.116.95:8080/api`.

The request body is set to `form-data` and includes two parameters:
*   `question` with the text value "Sales Analytics at GlobalRetail Insights".
*   `file` with the filename `q-clean-up-sales-data (7).json`, accompanied by a warning icon.

The response section shows a successful HTTP status of "200 OK", received in "3.68 seconds" with a size of "143 B". The response body is in JSON format, displaying `{"answer": "10887"}`.
image1384×644 48 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/9/b/9b64c8881a11f6110514f83dabb9e733f46865d9.png)

---

### Post #381 by HARISH. S on 2025-04-06T15:44:04.820Z
...
### Post #382 by Saransh Saini on 2025-04-06T16:17:58.832Z
...
### Post #383 by Saransh Saini on 2025-04-06T16:28:58.937Z
...
### Post #384 by Manit Bohra on 2025-04-06T16:59:11.468Z
...
### Post #385 by ABHIJEET KUMAR  on 2025-04-06T17:03:50.134Z
...
curl
 to send requests to each. You can pass headers, authentication tokens, or data as needed.

---

### Post #386 by HARISH. S on 2025-04-06T17:11:24.475Z
...
> **Image Description**: The image displays a computer screen showing a terminal window, with tabs visible at the top for "DEBUG CONSOLE", "TERMINAL", "PORTS", "QUERY RESULTS (PREVIEW)", and "COMMENTS".

The terminal output shows log entries from a `tds_app` process. These `INFO` level logs indicate "Processing question" for various natural language queries, including:
*   "LexiSolve Inc. is a startup that delivers a conve[rsation]"
*   "There is a tickets table in a SQLite database that"
*   "Search using the Hacker News RSS API for the lates[t news]"
*   "As a data analyst at DataSure Technologies, you ha[ve]"

Each processed question is associated with a specific Python file path (e.g., `E://data science tool//GA2//third.py`, `E://data science tool//GA3//second.py`, `E://data science tool//GA1//eighteenth.py`, `E://data science tool//GA4//sixth.py`, `E://data science tool//GA5//seventh.py`) and a numerical "score" (e.g., 8.30, 12.90, 5.90, 7.70, 14.50).

The logs also show HTTP `POST /ask HTTP/1.1` commands with a "200 OK" response, and a file path `C:\\Users\\hsent\\AppData\\Local\\Temp\\unleash-repo-schema-v1-codeium-language-server.json` related to a query. A "REDMI NOTE 12" watermark and the date "06/04/2025 22:40" are visible at the bottom of the screen.
10000831091920×1446 286 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/1/0/10ca02745240a3bbd4d5ab955b5c603275a32ee9.jpeg)

---

### Post #387 by Parthiv on 2025-04-06T17:30:28.788Z
...
### Post #388 by Manit Bohra on 2025-04-06T17:37:11.370Z
...
### Post #389 by ABHIJEET KUMAR  on 2025-04-06T17:40:03.992Z
...
### Post #390 by Vikram Suriyanarayanan on 2025-04-06T17:51:56.957Z
...
### Post #392 by Saransh Saini on 2025-04-06T19:20:56.079Z
...
### Post #393 by Yogesh on 2025-04-07T00:32:26.695Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/393

[@Saransh_Saini](/u/saransh_saini)
 I see a lot of 308’s as status codes in the logs I can see on render. Could you let me know if testing of my project was successful? Or if I did something wrong? My roll number is 21f2001573.

(A hint on my score would be welcome. ^_^)

---

### Post #394 by Parthiv on 2025-04-07T02:36:34.395Z
...
### Post #395 by Andrew David on 2025-04-07T05:17:43.616Z
...
### Post #396 by Andrew David on 2025-04-07T05:18:53.941Z
...
### Post #397 by Kartavya on 2025-04-07T05:49:49.403Z
...
### Post #398 by Sarang Tambe on 2025-04-07T08:44:09.217Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/398

[@Saransh_Saini](/u/saransh_saini)
 could you please give indication of how long we should keep the server running? Is it ok to shut those down now or will more evaluations be conducted?

---

### Post #399 by Saransh Saini on 2025-04-07T10:27:49.030Z
...
### Post #400 by Saransh Saini on 2025-04-07T10:32:36.488Z
...
### Post #401 by Shambhavi  on 2025-04-07T10:40:23.153Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/401

[@Jivraj](/u/jivraj)
 sir could you please check for 24f2003130… Today’s morning there was a glitch in my vercel…but I think since it was after evaluation it shouldn’t have impacted that…could you please verify it once

---

### Post #402 by Yogesh on 2025-04-07T10:43:25.324Z
...
### Post #403 by Saransh Saini on 2025-04-07T11:16:07.181Z
...
### Post #404 by Parthiv on 2025-04-07T11:27:52.796Z
...
### Post #405 by Saransh Saini on 2025-04-07T11:32:33.519Z
...
### Post #406 by HARISH. S on 2025-04-07T12:02:04.487Z
...
### Post #407 by Saransh Saini on 2025-04-07T12:20:58.912Z
...
### Post #408 by Parthiv on 2025-04-07T12:28:09.960Z
...
### Post #409 by ABHIJEET KUMAR  on 2025-04-07T12:28:59.901Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/409

[@saransh_saini](/u/saransh_saini)

[@carlton](/u/carlton)
 Can we kindly expect the result for Project 2 today?

---

### Post #410 by Saransh Saini on 2025-04-07T12:31:47.800Z
...
### Post #411 by DIGVIJAYSINH SANDEEPSINH CHUDASAMA on 2025-04-07T12:33:42.136Z
...
[@Jivraj](/u/jivraj)
 Could you please share an update on the expected results for P2? Also, could you confirm whether my evaluation has been completed?
...
### Post #412 by Aarush saxena  on 2025-04-07T12:34:28.740Z
...
### Post #413 by Vicky Kumar on 2025-04-07T12:35:30.715Z
...
> **Image Description**: The image displays a dark-themed interface presenting system information, data queries, and an API status alert. The top section shows "Total requests: 39" and one IP address "43.230.106.157" also with 39 requests. Recent queries include "InfoCore Solutions is a technology consulting firm that maintains an extensive internal knowledge ba...", "Develop a FastAPI application that:", and "Exposes a GET endpoint /execute?q=... where the query parameter...".

The middle section contains a prompt stating, "ESPN Cricinfo has ODI batting stats for each batsman. The result is paginated across multiple pages..." and advises to "Utilize IMDb's advanced web search at https://www.imdb.com/search/title/ to access movie dat...". Below this text is an "IMDb" label, an "Advanced search" link, and a large yellow square with the black IMDb logo.

The bottom section features an "ALERT: API Status" indicating "The API at app.algooch.tech is currently DOWN or experiencing issues." A detailed status box confirms "API is DOWN" with "Status: DOWN" and "Last checked: 2025-04-07 13:01:32".
image1543×875 50.7 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/7/9/79b265cdf296dd8ae706942f922eaf7bf6253edc.png)

---

### Post #414 by Saransh Saini on 2025-04-07T12:39:00.314Z
...
### Post #415 by Parthiv on 2025-04-07T12:42:49.364Z
...
### Post #416 by Pradeep Mondal on 2025-04-07T12:48:37.986Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/416

Hey
[@Saransh_Saini](/u/saransh_saini)
 ,  can you please confirm if my report was created or not so that I can turn off the vm on azure if it has been done already.

Thank you again!

---

### Post #417 by LAKSHAY on 2025-04-07T12:53:02.405Z
...
### Post #418 by HARISH. S on 2025-04-07T13:03:00.113Z
...
### Post #419 by Trebhuvan SB on 2025-04-07T16:31:53.538Z
...
### Post #420 by Saransh Saini on 2025-04-07T16:36:24.017Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/420

Yes,
[@21f2000709](/u/21f2000709)
 Your entire evaluation has been completed, along with your report generation. You may shutdown your VM.

---

### Post #421 by HARISH. S on 2025-04-07T16:48:33.125Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/421

![](https://dub1.discourse-cdn.com/flex013/user_avatar/discourse.onlinedegree.iitm.ac.in/harish.s/48/67995_2.png)
 HARISH.S:
...
### Post #422 by Shivaditya Bhattacharya on 2025-04-07T20:14:34.109Z
...
[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/0/a/0aec52c2574797f9b3c56589104b77ef4c82bb6d_2_690x387.png)image982×552 133 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/0/a/0aec52c2574797f9b3c56589104b77ef4c82bb6d.png)
...
[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/5/6/568addb34b3014bc9b4c0735ff554a6fbc1ca2c4_2_644x500.png)image831×645 41.7 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/5/6/568addb34b3014bc9b4c0735ff554a6fbc1ca2c4.png)
...
### Post #423 by LAKSHAY on 2025-04-07T20:18:54.592Z
...
### Post #424 by Saransh Saini on 2025-04-07T20:49:41.709Z
...
### Post #425 by Saransh Saini on 2025-04-07T20:55:24.124Z
...
### Post #426 by Yogesh on 2025-04-08T02:41:32.553Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/426

[@Saransh_Saini](/u/saransh_saini)
 Have I been evaluated? My roll number is 21f2001573.

---

### Post #427 by Pritul Santosh Raut  on 2025-04-08T02:58:52.606Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029
z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/481

![](https://dub1.discourse-cdn.com/flex013/user_avatar/discourse.onlinedegree.iitm.ac.in/23f2000237/48/66999_2.png)
 23f2000237:
...
Update
 - npm have released a status page incident, and users can monitor further updates here:
[https://status.npmjs.org](https://status.npmjs.org/)

Apr 11, 2025 - 03:02 UTC

Monitoring
 - We have observed authentication issues to private registries using npm access tokens. Affected users may see 4xx errors when installing private packages. Manually regenerating tokens appears to resolve this issue. At this time, there is no official statement from npm or GitHub regarding the root cause.

Apr 11, 2025 - 02:37 UTC

---

### Post #482 by Harsh Jaiswal on 2025-04-11T21:02:59.367Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/482

Yes I also got the same email, but when I checked my vercel dashboard I found no such api access. Kindly verify this
[@Saransh_Saini](/u/saransh_saini)
...
### Post #483 by S Smriti on 2025-04-14T05:58:53.974Z
...
### Post #484 by Shubhranshu Sharma on 2025-04-14T06:50:52.831Z
...
[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/e/d/edd1ea44892ef8fde6eff0c80a423dee376348d4.png)image402×599 23.3 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/e/d/edd1ea44892ef8fde6eff0c80a423dee376348d4.png)

aap link :
[https://tds-project2-21f3000591.onrender.com](https://tds-project2-21f3000591.onrender.com)

---

### Post #485 by Afsal on 2025-04-14T06:56:55.832Z
...
### Post #486 by Dhanashree Dhanwant  on 2025-04-14T07:36:50.520Z
...
hello sir, in my portal the project 2 score is showing absent even after submitting tds project 2 successfully in google form and keeping the server running all the time, please can you recheck it again, deployment link:
[https://tds-p2-gun1.onrender.com](https://tds-p2-gun1.onrender.com)

---

### Post #487 by Gaurav Ghodge on 2025-04-14T07:47:46.709Z
...
Hello Sir, my project 2 score is showing as 0. I had got email saying please update endpoint because earlier endpoint was having problems. I had sent
[https://c7f6-150-107-43-5.ngrok-free.app/api/](https://c7f6-150-107-43-5.ngrok-free.app/api/)
...
### Post #488 by Sakthivel S on 2025-04-14T08:14:31.481Z
...
### Post #489 by Aarush saxena  on 2025-04-14T08:16:38.295Z
...
### Post #490 by Gaurav Kumar on 2025-04-14T08:26:49.113Z
...
### Post #491 by Gayathri on 2025-04-14T08:31:13.891Z
...
### Post #492 by Srishty on 2025-04-14T09:25:44.671Z
...
### Post #493 by Sahil Raj  on 2025-04-14T09:58:04.751Z
...
I am writing to kindly request a re-evaluation of my Project 2 submission. As I had previously mentioned, the Render deployment link I submitted may take approximately
50 to 60 seconds
 to activate upon the first load. This behavior is typical of free-tier deployments on Render, and I assure you that the application functions correctly in both
Podman
 and
Linux
 environments.

Upon reviewing my Render logs, I could not find any indication that the project was accessed or evaluated during the expected activation time. To ensure smooth accessibility, I have also deployed the same GitHub repository on
Railway
 and submitted that link as well.

If possible, I kindly request either of the following:

Re-evaluation using the
Railway link
 I provided, or

Re-evaluation using the
Render link
, with allowance for the 50–60 second activation time.
...
### Post #494 by Shivaditya Bhattacharya on 2025-04-14T10:02:20.165Z
...
GET and POST requests tested via Postman and VS Code
, both return
200 OK
.
...
Tested on my laptop and by 10+ other people
 – all received correct results.

![:white_check_mark:](https://emoji.discourse-cdn.com/google/white_check_mark.png?v=14)

No issues seen in logs or deployment
 – everything was set up properly.

![:white_check_mark:](https://emoji.discourse-cdn.com/google/white_check_mark.png?v=14)

Others in my group got full marks
...
I’ve spent weeks working on this project
, including sleepless nights.

![:red_exclamation_mark:](https://emoji.discourse-cdn.com/google/red_exclamation_mark.png?v=14)

This is my last term
 – if I fail, I will have to repeat the entire diploma.

Please recheck my project thoroughly. Here are the important links for you to verify:

API Documentation:

[FastAPI - Swagger UI](http://shashitdsproject2.centralindia.cloudapp.azure.com/docs)

API Endpoint:

[http://shashitdsproject2.centralindia.cloudapp.azure.com/api](http://shashitdsproject2.centralindia.cloudapp.azure.com/api)
...
[![vm start](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X
z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/512

[](#p-619131-request-for-re-evaluation-1)
Request for Re-evaluation

I have completed the entire project and ensured that my model is working correctly. Despite this, I have received
zero marks
...
### Post #513 by D HARICHARAN  on 2025-04-14T17:13:33.434Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/513

project url:
[https://tdsproject2-eight.vercel.app/](https://tdsproject2-eight.vercel.app/)

---

### Post #514 by Vijaya Tiwary on 2025-04-14T17:21:16.708Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/514

Dear Sir,

In my course dashboard, Project 2 score is shown as zero. However, I had submitted the repository and API endpoints (
[http://35.192.157.22.80](http://35.192.157.22.80)
) through the Google Form. I had received a mail to make edit in API end point if changed. I had edited my api end point by adding  /api/ and it was
[http://35.192.157.22/api/](http://35.192.157.22/api/)
. My server was running fine. I have worked hard to do this project and now receiving a score of zero. Kindly look into it.

---

### Post #515 by Suneha Datta on 2025-04-14T17:26:19.741Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/515

Sir I have also recieved 0 marks, but I checked now also using python requests library and my server is working fine .  But I see a lot of GET requets instead of POST in my logs file which was for the past couple of days requests, which is very unlikely . Please check my link again , its still active . App link  -
[http://16.16.189.187:8000/tdsp2](http://16.16.189.187:8000/tdsp2)

My test file-

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/8/a/8a72f99a42e98345296c57cf96b29b58cc74a61f_2_690x325.png)image1331×627 52.2 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/8/a/8a72f99a42e98345296c57cf96b29b58cc74a61f.png)

My server log file -

[![Screenshot 2025-04-14 144745](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d/9/d95fbefa675ef4f9ed9d098e7243cf945a05944b.png)Screenshot 2025-04-14 144745934×490 31.1 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d/9/d95fbefa675ef4f9ed9d098e7243cf945a05944b.png)
...
### Post #516 by Kaif Fazal on 2025-04-14T18:56:01.918Z
...
Additionally, my
Vercel server is still active
, and the API is functioning correctly, which can be verified here:
...
I also have a
response copy from the forum confirming my submission
, including both the GitHub and Vercel links, as proof. I kindly request you to review this and take the necessary steps to update my project status.

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/4/3/43ab3b1ef96ed66a52f31fa44db97ca0a3dda6bd_2_690x295.png)image1503×644 37.4 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/4/3/43ab3b1ef96ed66a52f31fa44db97ca0a3dda6bd.png)

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/3/e/3eb72913606e2d5777075f5876d1198eda100359_2_690x345.png)image1905×953 32.7 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/3/e/3eb72913606e2d5777075f5876d1198eda100359.png)

---

### Post #517 by Pritul Santosh Raut  on 2025-04-15T02:37:15.899Z
...
### Post #518 by Aditya goyal on 2025-04-15T03:53:21.446Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/518

Request a re-evaluation of my
Project 2
 score. Despite submitting the project as per the given deadlines, my portal currently shows a score of
0
.
...
### Post #519 by Lovepreet Singh on 2025-04-15T07:26:14.412Z
...
### Post #520 by Carlton D'Silva on 2025-04-15T07:51:56.000Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/520

[@Saransh Saini](mailto:22f1001123@ds.study.iitm.ac.in)

[@JIVRAJ SINGH SHEKHAWAT](mailto:22f3002542@ds.study.iitm.ac.in)
 Please coordinate and check the issues raised. Thanks & Regards

---

### Post #521 by Esakki Raja R on 2025-04-15T09:41:26.727Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/521

For TDS project 2, it is showing 0 in course dashboard, but when I tested the URL it is working fine. Is there any log similar to project1 to check what gone wrong?  Could you please check on this sir?
[@carlton](/u/carlton)
...
### Post #522 by Bhavana G V on 2025-04-15T10:41:22.312Z
...
I need your immediate attention regarding my
project-2 , as I received zero marks,
 but
my server is running completely fine
. Below are the key points that I need you to look into:
...
[![Screenshot 2025-04-15 153318](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X
z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/604

[@carlton](/u/carlton)
 I appreciate your response. I didn’t include “/api” at the end. Could you confirm if I’m allowed to update the form now before tonight’s evaluation? Thanks in advance.

---

### Post #605 by  KARTHIK on 2025-04-16T13:41:33.190Z
...
[![IMG_20250416_190813](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/7/5/759ec985e0ecf4fb7889c8ba0de05f3e9ad78414_2_247x500.jpeg)IMG_20250416_1908131080×2182 234 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/7/5/759ec985e0ecf4fb7889c8ba0de05f3e9ad78414.jpeg)

---

### Post #606 by Mouhurtik Ray on 2025-04-16T13:51:55.650Z
...
[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/5/7/57caf380ea25455122ddb81e1e55ddece3066378_2_601x500.png)image1126×936 61.3 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/5/7/57caf380ea25455122ddb81e1e55ddece3066378.png)
...
### Post #607 by Carlton D'Silva on 2025-04-16T14:03:03.062Z
...
### Post #608 by Lovepreet Singh on 2025-04-16T14:04:46.728Z
...
### Post #609 by Swati Kapoor on 2025-04-16T14:12:21.080Z
...
[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/1/e/1e23c8a5b32bfb39bb7bd64e88135bdd6007c9d3_2_690x431.png)image1039×650 50.9 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/1/e/1e23c8a5b32bfb39bb7bd64e88135bdd6007c9d3.png)

Please suggest the way forward.

---

### Post #610 by Jivraj Singh Shekhawat on 2025-04-16T14:36:02.233Z
...
### Post #611 by Gaurav Ghodge on 2025-04-16T14:41:24.879Z
...
### Post #612 by Jivraj Singh Shekhawat on 2025-04-16T14:51:14.952Z
...
### Post #613 by Afsal on 2025-04-16T14:59:39.984Z
...
### Post #614 by Sahil Raj  on 2025-04-16T15:01:24.742Z
...
After some investigation, I found that the issue is related to DNS resolution. The API becomes accessible when using
public DNS services
 like
Google (8.8.8.8)
 or
Cloudflare (1.1.1.1)
. This suggests that the current deployment environment may be using a restricted or unreliable DNS resolver, which causes access issues on some networks (e.g., Jio).

[](#p-620347-suggested-fix-1)
![:hammer_and_wrench:](https://emoji.discourse-cdn.com/google/hammer_and_wrench.png?v=14)
 Suggested Fix:

To ensure reliable access for all students, could you please consider updating the deployment or testing environment to use a
public DNS
 provider?
...
[](#p-620347-alternate-option-2)
![:repeat_button:](https://emoji.discourse-cdn.com/google/repeat_button.png?v=14)
 Alternate Option:

If the DNS change isn’t possible at the moment, I kindly request that you evaluate my project using the
previously deployed endpoint
 instead:

https://tds-project-2-pnlm.onrender.com/api/

Please note that this endpoint may take
50 to 60 seconds
 to respond, as it’s hosted on a platform with a cold start delay — but it is fully functional and provides the correct outputs.
...
### Post #615 by Kartikay Taunk on 2025-04-16T15:49:14.408Z
...
### Post #616 by Reva Lakshmy Paul on 2025-04-16T15:51:49.872Z
...
### Post #617 by Carlton D'Silva on 2025-04-16T15:58:16.822Z
...
### Post #618 by Shiva varshney  on 2025-04-16T16:40:37.908Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/618

what should i do , i deleted my vm after the email that your evaluation completed , it is said in email that evaluation log and score will be sent but nothing come , it seems my updated api endpoint is not evaluated , score comes from previous endpoint , please what to do now ? again i am saying i deleted my vm
[@s.anand](/u/s.anand)
...
### Post #619 by Jerin John on 2025-04-16T16:50:55.693Z
...
In the google form which we submitted I had pasted the API endpoint as the one which I got in the vercel dashboard i.e.
[https://tds-project2-rho.vercel.app/](https://tds-project2-rho.vercel.app/)

whereas the correct api for giving post requests has
/api
 added to the above which i forgot to add. i.e**.
[https://tds-project2-rho.vercel.app/api/**](https://tds-project2-rho.vercel.app/api/**)
...
### Post #620 by Pritul Santosh Raut  on 2025-04-16T17:05:08.736Z
...
These are my new endpoints:
[https://gasolver-hgayefe7b0avhpc6.southindia-01.azurewebsites.net/api/](https://gasolver-hgayefe7b0avhpc6.southindia-01.azurewebsites.net/api/)
           I have replied to the email regarding the re-evaluation message that was sent to me. Since I deleted the Azure Web Service Plan after receiving instructions from the TDS team to stop the service, I now need to host it again .Please let me know the next steps.

---

### Post #622 by Rahul Pathak on 2025-04-16T17:14:52.726Z
...
please use this api url -:
[https://rahulbot-a369.onrender.com/api/](https://rahulbot-a369.onrender.com/api/)

instead of this -
[https://rahulbot-a369.onrender.com/](https://rahulbot-a369.onrender.com/)
...
### Post #623 by Jivraj Singh Shekhawat on 2025-04-16T17:41:11.328Z
...
### Post #625 by Carlton D'Silva on 2025-04-16T17:48:09.195Z
...
[https://forms.gle/m2pzirzGvphPB5zq8](https://forms.gle/m2pzirzGvphPB5zq8)

---

### Post #626 by Vicky Kumar on 2025-04-16T17:48:56.626Z
...
[![1000063856](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/d/b/db761b4fc8a46e49b51c3b587e5d8a77402031f9_2_690x308.jpeg)10000638561920×858 139 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d/b/db761b4fc8a46e49b51c3b587e5d8a77402031f9.jpeg)

---

### Post #627 by Jivraj Singh Shekhawat on 2025-04-16T17:57:02.894Z
...
### Post #628 by Gaurav Ghodge on 2025-04-16T18:04:19.307Z
...
I have received 5 “200 OK” POST requests on my ngrok endpoint(which i had sent replying to
[@Jivraj](/u/jivraj)
 email before 10:30 PM) between 11:02 PM to 11:05 PM.
...
### Post #629 by HARISH. S on 2025-04-16T18:09:39.408Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/629

[@carlton](/u/carlton)
 yes sir same doubt as
[@GaURaVinDeX](/u/gauravindex)
 . i also got 5 200 ok requests in my terinal. i sent the url to the mail i got before. do i need to update this gform again? or  Or is everything done from my end?

I m keeping server on till tomorrow morning.

---

### Post #630 by Carlton D'Silva on 2025-04-16T18:21:10.896Z
...
### Post #631 by HARISH. S on 2025-04-16T18:21:48.949Z
...
### Post #632 by Carlton D'Silva on 2025-04-16T18:22:18.916Z
...
### Post #633 by Gaurav Ghodge on 2025-04-16T18:22:26.877Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/633

Sir, I replied to the email received by me from
[@jivraj](/u/jivraj)
 as it was instructed. Should i fill gform now also?

---

### Post #634 by Carlton D'Silva on 2025-04-16T18:23:05.796Z
...
### Post #635 by Gaurav Ghodge on 2025-04-16T18:25:06.406Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/635

Ok. Because our gform of 10th April has old ngrok endpoint which isnt valid now. Only the one which we have emailed to
[@Jivraj](/u/jivraj)
 before 10:30 PM is current active. So i conclude our emailed ngrok endpoints of today to
[@Jivraj](/u/jivraj)
 are enough.

---

### Post #636 by Carlton D'Silva on 2025-04-16T18:28:37.715Z
...
### Post #637 by Saini Nirmal on 2025-04-16T18:32:06.565Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029
KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d/1/d16ed1d7d739a3779a907f08137a1f4626a1aee2.png)

---

### Post #682 by Aditya goyal on 2025-04-17T13:42:26.377Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/682

[![WhatsApp Image 2025-04-17 at 19.08.01](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/8/3/83dedb4b92660b023148b9c5a1996c8413278ad0_2_690x166.jpeg)WhatsApp Image 2025-04-17 at 19.08.011600×385 66.9 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/8/3/83dedb4b92660b023148b9c5a1996c8413278ad0.jpeg)

I would like to highlight an issue regarding the evaluation of the TDS Solver Project 2.

As per the official project instructions, our API was clearly required to handle
POST
 requests at /api/ with multipart/form-data.

Nowhere in the documentation was it mentioned that the API should handle
GET
 requests.

However, during evaluation, GET requests seem to be made to the endpoint, leading to
...
Therefore, I request that the evaluation team
only test using POST requests
 as originally instructed.

Penalizing students because of unnecessary GET requests would be
...
### Post #683 by Sathya  on 2025-04-17T13:43:34.647Z
...
[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/d/1/d123698466d8ed43a79a92f69e4752b3730b3e77_2_690x321.jpeg)image1942×904 203 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d/1/d123698466d8ed43a79a92f69e4752b3730b3e77.jpeg)

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/f/8/f8ba75a5c899794a86005120ac8d0af1dba85cf0_2_690x324.png)image1936×910 128 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/f/8/f8ba75a5c899794a86005120ac8d0af1dba85cf0.png)

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/d/b/db93b66e0ad980008bf6fcb646ee499e77ca12b9_2_690x330.png)image1940×928 137 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d/b/db93b66e0ad980008bf6fcb646ee499e77ca12b9.png)

If there are any additional scenarios you’d like me to test, feel free to let me know, I’d be happy to help validate that the endpoint is functioning as expected.
[@carlton](/u/carlton)
...
### Post #684 by Manu C on 2025-04-17T13:47:01.539Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/684

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/3/b/3b6b9fef6202e7f8e3eef43a416632f4c7f44442.png)image1430×142 5.42 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/3/b/3b6b9fef6202e7f8e3eef43a416632f4c7f44442.png)

the answer is correct expect for extra spaces it was told that those spaces are neglectable still it showed as error plz consider this
[@carlton](/u/carlton)

---

### Post #685 by Vicky Kumar on 2025-04-17T14:45:57.873Z
...
“api”: “
[https://app.algsoch.tech/api/](https://app.algsoch.tech/api/)
”,
...
[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/4/4/445cb5154e62aff942d0c688f1675e60fece3865.png)image640×238 10.6 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/4/4/445cb5154e62aff942d0c688f1675e60fece3865.png)
...
“actual”: “
[GitHub - sminez/ad: an adaptable text editor](https://github.com/sminez/ad)
”,
...
[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/1/4/1491bca832e4df4bbdbb7da52e2e9b63477a1839.png)image855×383 19.5 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/1/4/1491bca832e4df4bbdbb7da52e2e9b63477a1839.png)
...
### Post #686 by Vicky Kumar on 2025-04-17T14:59:36.097Z
...
[](#p-620881-what-went-wrong-on-api-side-3)
...
[](#p-620881-insight-4)
![:light_bulb:](https://emoji.discourse-cdn.com/google/light_bulb.png?v=14)
 Insight:
...
### Post #687 by Manu C on 2025-04-17T17:39:33.861Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/687

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/f/5/f5178de7b817bd185e7190f821cf28c505ac25e1.png)image1491×166 5.46 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/f/5/f5178de7b817bd185e7190f821cf28c505ac25e1.png)
...
### Post #688 by Pratyush Pulak Nishank on 2025-04-18T01:59:34.184Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029
z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/710

I have received the test result of Project 2 todat afternoon, it is showing GA 2 question 2 has failed but my answer is a hardcoded url (“
[https://23f2004837.github.io/](https://23f2004837.github.io/)
”) from the code. This url is accessible and again tested of the GA platform for the same question and it is working as expected

Code:

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/d/c/dcb0ef9bdea43b2b852aa586c8c7230a70e783f0_2_663x500.png)image1712×1290 285 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/d/c/dcb0ef9bdea43b2b852aa586c8c7230a70e783f0.png)

url result:

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/5/1/51eb6aa84b57bc9d3cfc1e19f341e86c85452318_2_690x305.png)image898×398 28.9 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/5/1/51eb6aa84b57bc9d3cfc1e19f341e86c85452318.png)

html elements:

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/4/2/42a64456808f873555ff4de31837f03230d11cc7_2_690x236.png)image1230×422 40.7 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/4/2/42a64456808f873555ff4de31837f03230d11cc7.png)

GA portal:

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/7/7/77d9640fb9b880c88e9a584b9ede792c689fbe11_2_690x240.png)image2432×846 224 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/7/7/77d9640fb9b880c88e9a584b9ede792c689fbe11.png)

[![image](https://europe1.discourse-cdn.com/flex013/uploads/iitm/optimized/3X/4/7/4785d546f9503ff0afe19412b56481c7aa53398b_2_690x122.png)image1286×228 19.3 KB](https://europe1.discourse-cdn.com/flex013/uploads/iitm/original/3X/4/7/4785d546f9503ff0afe19412b56481c7aa53398b.png)
...
### Post #712 by PREMDEEP MAITI on 2025-04-20T13:09:43.983Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/712

What’s the error in the log? It’s GA2 Question 3. I can see u haven’t wrapped your email address inside
<!--email_off-->
 tag.

---

### Post #713 by PREMDEEP MAITI on 2025-04-20T13:12:23.829Z
...
I have posted my  Project 2 Discrepency here
[Urgent Attn Needed: Project 2 Discrepency for GA2_q3 and GA1_q18](https://discourse.onlinedegree.iitm.ac.in/t/urgent-attn-needed-project-2-discrepency-for-ga2-q3-and-ga1-q18/173113)
:

---

### Post #714 by Saini Nirmal on 2025-04-20T14:37:01.504Z
...
### Post #715 by Vicky Kumar on 2025-04-25T17:08:56.564Z
**Post URL**: https://discourse.onlinedegree.iitm.ac.in/t/project-2-tds-solver-discussion-thread/169029/715

[@s.anand](/u/s.anand)

Subject:
 Request to Share My Student-Built TDS Assistant Platform
...
I’m
Vicky Kumar
, a student from the Data Science and Applications program at
IIT Madras
. Over the last few months, I’ve built a personal project called
“Vicky App”
 — a smart assistant platform specifically designed to help students in courses like
TDS,
.

The system is capable of:

Accurately solving over
90% of assignment-style questions
 using regex and phonetic matching
...
[](#p-622891-whats-in-it-for-students-1)
![:light_bulb:](https://emoji.discourse-cdn.com/google/light_bulb.png?v=14)
...
I’ve made it
free for the first 3 questions

After that, students can access the full platform for just
₹199/month
, which helps me cover system maintenance and hosting costs

[](#p-622891-my-humble-request-2)
![:folded_hands:](https://emoji.discourse-cdn.com/google/folded_hands.png?v=14)
 My Humble Request:
...
It’s built
by an IIT Madras student, for IIT Madras students
 — with the sole goal of making their learning smoother, faster, and smarter.
...
![:e_mail:](https://emoji.discourse-cdn.com/google/e_mail.png?v=14)

[npdimagine@gmail.com](mailto:npdimagine@gmail.com)
 |
![:mobile_phone:](https://emoji.discourse-cdn.com/google/mobile_phone.png?v=14)
 +91 8383848219

![:globe_with_meridians:](https://emoji.discourse-cdn.com/google/globe_with_meridians.png?v=14)

[Portfolio](https://sites.google.com/view/vicky-kumar/home)
 |
